...
void joy_callback(const sensor_msgs::Joy &joy_msg)
{
  ...
  //float gas = (joy_msg.axes[2]*-7+183)/2;//top
  float gas = (joy_msg.axes[2]*-11+183)/2;//overtop
  ...
  //float brake = joy_msg.axes[3]*11+102;//top
  float brake = joy_msg.axes[3]*(11)+101;//overtop
